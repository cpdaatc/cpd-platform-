...
export const PERMISSIONS=[
  ...
  'ai.run_prereview','ai.manage_references','ai.resolve_source_conflict','ai.settings.configure','ai.settings.approve',
  ...
  'external.manage','external.view','impact.manage','impact.view','impact.finalize','impact.correction.request','impact.correction.approve','methodology.configure','methodology.approve',
...
const ROLE_PERMISSIONS:Record<GovernanceRole,readonly Permission[]>={
  ...
  ORGANIZATION_SYSTEM_ADMIN:[
    ...
    'ai.run_prereview','ai.manage_references','ai.resolve_source_conflict','ai.settings.configure','committee.manage_structure','evidence.record_offline','evidence.readiness.view',
    'external.manage','external.view','impact.manage','impact.view','impact.finalize','impact.correction.request','methodology.configure','annual.generate','annual.view',
    'notification.view','notification.manage','template.manage','report.view','audit.view',
  ],
  ACTIVITY_OFFICER:['activity.view.assigned','activity.fill_submit','activity.submit_committee','ai.run_prereview','evidence.readiness.view','external.manage','external.view','impact.manage','impact.view','impact.finalize','impact.correction.request','notification.view'],
  ...
  MANAGEMENT_APPROVER:['external.view','impact.view','annual.view','evidence.readiness.view','notification.view','template.approve','report.view','methodology.approve','impact.correction.approve','ai.settings.approve','annual.acknowledge'],
