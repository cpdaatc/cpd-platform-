...
select public._assert(
  exists(select 1 from public.activities where organization_id='90000000-0000-0000-0000-000000000010' and title_ar='نشاط اللجنة' and internal_state='APPROVED_FOR_SCFHS_SUBMISSION'),
  'phase4 approved activity is available for external tracking'
);
...
select public._assert(
  ...
  'internal readiness state remains separate from external decision'
);
